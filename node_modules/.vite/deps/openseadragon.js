...
var require_openseadragon = __commonJS({
  "node_modules/openseadragon/build/openseadragon/openseadragon.js"(exports, module) {
    ...
    (function($) {
      ...
      $.MouseTracker.wheelEventName = $.Browser.vendor === $.BROWSERS.IE && $.Browser.version > 8 || "onwheel" in document.createElement("div") ? "wheel" : document.onmousewheel !== void 0 ? "mousewheel" : "DOMMouseScroll";
    ...
    (function($) {
      ...
      $.extend($.IIIFTileSource.prototype, $.TileSource.prototype, {
        ...
        getTileUrl: function(level, x, y) {
          ...
          var IIIF_ROTATION = "0", scale = Math.pow(0.5, this.maxLevel - level), levelWidth = Math.round(this.width * scale), levelHeight = Math.round(this.height * scale), tileWidth, tileHeight, iiifTileSizeWidth, iiifTileSizeHeight, iiifRegion, iiifTileX, iiifTileY, iiifTileW, iiifTileH, iiifSize, iiifSizeW, iiifSizeH, iiifQuality, uri;
    ...
    (function($) {
      ...
      $.extend($.TiledImage.prototype, $.EventSource.prototype, {
        ...
        _drawTiles: function(lastDrawn) {
          ...
          if (lastDrawn.length > 1 && imageZoom > this.smoothTileEdgesMinZoom && !this.iOSDevice && this.getRotation(true) % 360 === 0 && $.supportsCanvas && this.viewer.useCanvas) {
            useSketch = true;
