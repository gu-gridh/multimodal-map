...
const messages = {
    en: {
      ...
      dataset: "Dataset",
      searchpanels: "Search for a field or inscription",
      ...
      panelsshown: "Fields shown",
      panelshidden: "Fields hidden",
    ...
    uk: {
      ...
      dataset: "Dataset",
      searchpanels: "Знайдіть поле або напис",
      inscriptions: "Hаписи",
      ...
      threedmodel: "3D Model",
      threedmodels: "3D models",
      panelsshown: "Показані поля",
      panelshidden: "Поля приховані",
      photographs: "Photographs",
      plans: "Плани",
      type: "Type",
      period: "Period",
