...
const messages = {
  en: {
    ...
    f1description: "Use the centrally placed widget at the top of the screen to switch between an interactive plan of the cathedral, a gallery of the documented Surfaces, a gallery of the individual inscriptions or a summary of all the data.",
    ...
    f3description: "To the left you have controls to filter down the result to inscriptions of a particular type (textual, pictorial or composite), by genre and description or by writing system and language. Use the tags at the bottom right of the surfaces and inscriptions galleries to further filter down and narrow the result.",
    ...
    f5title: "Get a data summary",
    f5description: "In the summary view you get an overview of the inscriptions expressed in numbers and charts. You can export the data as CSV-files or as images.",
  ...
  uk: {
    ...
    f1description: "Використовуйте центрально розміщений віджет у верхній частині екрана, щоб перемикатися між інтерактивним планом собору, галереєю задокументованих поверхонь, галереєю окремих написів або зведенням усіх даних.",
    ...
    f3description: "Ліворуч розміщені елементи керування, які допоможуть відфільтрувати результат за написами певного типу (текстовими, графічними чи комбінованими), за жанром і описом або за системою письма та мовою. Використовуйте теги в нижній правій частині галерей поверхонь і написів, щоб додатково відфільтрувати та звузити результат.",
    ...
    f5title: "Отримати підсумок даних",
    f5description: "У зведеному перегляді ви отримуєте огляд написів, представлений у вигляді чисел і діаграм. Ви можете експортувати дані у форматі CSV або як зображення.",
