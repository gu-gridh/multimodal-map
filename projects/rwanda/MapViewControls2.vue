...
// ONLY KEEPING THIS FILE FOR REFERENCE
...
const {sources, placeTypes, informants, periods, periodsLayer} = storeToRefs(rwandaStore());
...
// watch(() => [periods.value], () => {
//   if(periods.value.length != 0){
//     allPeriods.value = false
//     periodsLayer.value = false
//   } else {
//     allPeriods.value = true
//   }
// })
//TODO - Unckeck others when All is checked
//TODO - Filter map on Filter-button click
//
const handleFilter = () => {
  console.log("Filtering map")
  console.log(sources.value)
  console.log(placeTypes.value)
  console.log(informants.value)
  if(periods.value != null) {
    console.log("not all periods")
  ...
  <div class="filter-container">
    <div class="filter-heading">Sources</div>
      ...
      <div style="margin-top: 10px;">
        <button class="p-1 px-3 clickable category-button" @click="handleFilter()">Filter map</button>
      </div>
  </div>
</template>
