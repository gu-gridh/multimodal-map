              ...
              <div class="placecard-metadata-content">
                <ul class="sample-id-list">
                  <li v-for="(date, index) in previewData['radiocarbon_dates']" :key="index">
                    <span class="label-box" @click.stop="navigateToDetail('radiocarbon_date', date.id)">
              ...
              <div class="placecard-metadata-content">
                <ul class="sample-id-list">
                  <li v-for="(analysis, index) in previewData['metal_analysis']" :key="index">
                    <span class="label-box" @click.stop="navigateToDetail('https://maritime-encounters.dh.gu.se/api/resources/metalanalysis/', analysis.id)">
              ...
              <div class="placecard-metadata-content">
                <ul class="sample-id-list">
                  <li v-for="(sample, index) in previewData['new_samples']" :key="index">
                    <span class="label-box" @click.stop="navigateToDetail('https://maritime-encounters.dh.gu.se/api/resources/newsamples/', sample.id)">
              ...
              <div class="placecard-metadata-content">
                <ul class="sample-id-list">
                  <li v-for="(item, index) in previewData['metalwork']" :key="index">
                    <span class="label-box" @click.stop="navigateToDetail('https://maritime-encounters.dh.gu.se/api/resources/metalwork/', item.id)">
                      Metalwork {{ item.id }}
                    </span>
                  </li>
                </ul>
