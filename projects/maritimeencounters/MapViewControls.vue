...
const { categories, selectedRange, tags, necropoli, tombType, dataSetValue, dataParams, selectedNecropolisCoordinates, enable3D, enablePlan, selectedSite, showUnknownRange } = storeToRefs(maritimeencountersStore());
