...
<template>
  ...
  <div style="display:flex; align-items: center; justify-content: center; pointer-events: none;">
    ...
    <div class="ui-mode ui-overlay ui-overlay-top">
      ...
      <button class="item" :class="{ selected: showSummary }" @click="switchToSummary" title="Summary">
        {{ $t('summary') }}
      </button>
    </div>
    ...
    <div class="legend" v-if="showLegend">
      ...
      <div class="legend-color-group">
        <div class="legend-swatch-title legend-bg">80 - 200</div>
        <div class="legend-swatch" style="background-color:rgba(180, 0, 0, 1.0)"> </div>
      </div>
...
@media screen and (max-width: 400px) {
  .ui-mode.ui-overlay.ui-overlay-top button.item {
    font-size: 0.8em;
  }
}
