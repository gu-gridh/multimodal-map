  ...
  <footer id="footer">
    <div id="developer-info">
      <div class="links-stack">
        <a class="site-link link" href="https://github.com/gu-gridh/documentation/blob/main/saintsophia.md#saint-sophias-inscriptions" target="_blank">GitHub
      ...
      <div class="links-stack border-style">
        <a class="site-link link" href="https://github.com/gu-gridh/documentation/blob/main/saintsophia.md#datasets"
      ...
      <div class="links-stack border-style extra">
        <a class="site-link link" href="https://github.com/gu-gridh/documentation/blob/main/saintsophia.md#project-team" target="_blank">Project team</a>
