      ...
      <div class="content-columns">
        ...
        <div class="content-column2">
          ...
          <div class="instructions-item">
            ...
            <div class="instructions-item-description">
              <div class="instructions-item-title">Filter by Genre and Keywords</div>
          ...
          <div class="instructions-item">
            <div class="instructions-item-icon"
              style="background-image:url(https://data.dh.gu.se/ui-icons/search_white.png)"></div>
            <div class="instructions-item-description">
              <div class="instructions-item-title">Filter by Language or Type of Inscription</div>
          ...
          <div class="instructions-item">
            <div class="instructions-item-icon"
              style="background-image:url(https://data.dh.gu.se/ui-icons/inspect_white.png)"></div>
            <div class="instructions-item-description">
              <div class="instructions-item-title">Interactive Plan</div>
              <p>The interactive plan shows the position of all the documented surfaces rendered on top of a
                ...
                ranging from yellow to bright red. Switch beteeen Ground Floor and Second Floor with the widget at the
                bottom of the page.
          ...
          <div class="instructions-item">
            <div class="instructions-item-icon"
              style="background-image:url(https://data.dh.gu.se/ui-icons/search_white.png)"></div>
            <div class="instructions-item-description">
              <div class="instructions-item-title">Powerful Search</div>
